        ...
        <table className="min-w-full text-left text-gray-800">
            ...
            <tbody className="divide-y divide-gray-200 text-xs md:text-base bg-white">
                <tr className="hover:bg-yellow-50">
                    <td className="px-3 md:px-6 py-3 md:py-4 font-medium text-green-900">PP</td>
                    <td className="px-3 md:px-6 py-3 md:py-4">#5</td>
                    <td className="px-3 md:px-6 py-3 md:py-4">Caps, containers, automotive</td>
                    <td className="px-3 md:px-6 py-3 md:py-4">Low</td>
                    <td className="px-3 md:px-6 py-3 md:py-4">rPP for auto parts, packaging</td>
                </tr>
            </tbody>
        </table>
    </div>
