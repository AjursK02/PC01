  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
      <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-center">
        {/* --- Left Side --- */}
        <div className="bg-blue-900/40 shadow-lg rounded-2xl p-6 md:p-10">
          <h2 className="font-headline text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
            Turn Everyday Waste into Value — Sell Scrap Online with <span className="text-green-600">Penaca!</span>
          </h2>
          <p className="mt-4 md:mt-6 text-sm md:text-lg text-white">
        ...
        <Card className="shadow-lg">
          <CardHeader className="px-4 md:px-6">
            ...
            <CardDescription className="text-xs md:text-sm">Fill out the form to become a registered supplier.</CardDescription>
          </CardHeader>
          <CardContent className="px-4 md:px-6">
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="space-y-1.5 md:space-y-2">
                ...
                <Input id="company" name="company" placeholder="Your Company Inc." disabled={isSubmitting} className="text-sm md:text-base" />
              </div>
              <div className="space-y-1.5 md:space-y-2">
              ...
              <div className="sm:col-span-2 space-y-1.5 md:space-y-2">
                <Label htmlFor="material-type" className="text-sm md:text-base">Type of Scrap Material</Label>
                <Select value={materialType} onValueChange={setMaterialType} required disabled={isSubmitting}>
                  <SelectTrigger id="material-type" className="text-sm md:text-base">
              ...
              <div className="sm:col-span-2 space-y-1.5 md:space-y-2">
                <Label htmlFor="quantity" className="text-sm md:text-base">Average Monthly Quantity (in Tons)</Label>
                <Input id="quantity" name="quantity" type="number" placeholder="e.g., 5" required disabled={isSubmitting} className="text-sm md:text-base" />
              </div>
              <div className="sm:col-span-2 space-y-1.5 md:space-y-2">
                <Label htmlFor="address" className="text-sm md:text-base">Pickup Address</Label>
                <Textarea id="address" name="address" placeholder="Enter your full pickup address" required disabled={isSubmitting} className="text-sm md:text-base" />
              </div>
